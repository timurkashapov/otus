...
>     _Рекомендации по реализации вычисления чисел Фибоначчи через матричный алгоритм:
...
>     4. Алгоритм поиска чисел Фибоначчи +1 балл
>     4d. Через умножение матриц (по желанию) +1 балл
>     +1 балл за отправку домашнего задания до начала след. вебинара._
>     
Рекомендуем сдать до: 20.05.2019_


#### 2019-05-21_otus_algo_05

5. Сортировка вставками, сортировка Шелла, сортировка выбором, пузырьковая сортировка.
...
>
>_Как сравнивать производительность:
>
...
>   - проведено сравнение производительности Shell sort с разными последовательностями шагов - 1 балл_
>
Рекомендуем сдать до: 22.05.2019

#### 2019-05-23_otus_algo_06
...
>         - Дополнительно 3: реализовать очередь с приоритетами при помощи heap, сравнить с тем, что было ранее сделано - без баллов, по своему желанию (т.к. нам сложно гарантировать быструю проверку)_

> Рекомендуем сдать до: 27.05.2019


#### 2019-05-28_otus_algo_07
...
>    - делать оба алгоритма не обязательно, но при желании можно, баллы ставятся за лучший :_

#### 2019-05-30_otus_algo_08
...
#### 2019-06-04_otus_algo_09

9. Сортировка за линейное время. Поиск порядковых статистик за линейное время.
...
>
>  _Сравнить производительность операций с AVL деревом.
...
> 
> 1.2 _Или_: реализовать хеш-таблицу с открытой адресацией
